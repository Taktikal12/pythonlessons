...
# kortej = "Lesson9", "Lesson8",
# print("Joined string:", " ".join(kortej))
...
t = tuple(random.sample(range(1, 100), 5))
sorted_t = tuple(sorted(t))
print(f"Оригинал: {t}, Отсортированный: {sorted_t}")
