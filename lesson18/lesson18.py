...
# 🔹 Генерация собственных (т.е сами) исключений:
...
#     # except TypeError: # Если вместо (а и b: будут буквы)
#     #     return "Ошибка: тип данных не числовой"
...
# 2. Создай функцию get_number(), которая принимает строку и преобразует её в число.
# Обработай исключение, если строка не преобразовывается в число.

# def get_number(s):
#     try:
#         return int(s)
#     except ValueError:
#         print(f"Ошибка: '{s}' нельзя преобразовать в число.")
#         return None
#
...
def open_or_create_file():
    try:
        ...
        with open("input.txt", "w") as f:
            f.write("Файл создан")
        print("Файл не найден, поэтому был создан и в него записано: 'Файл создан'.")
...
#
# input_str = "1 2 три 4"
# parsed = parse_numbers(input_str)
# print(parsed)  # [1, 2, 4]
